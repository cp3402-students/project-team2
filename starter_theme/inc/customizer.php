<?php
/**
 * Starter__Theme Theme Customizer
 *
...
function starter_theme_customize_preview_js() {
	wp_enqueue_script( 'starter_theme-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
