<?php
/**
 * Starter__Theme functions and definitions
 *
...
function starter_theme_setup()
{
     ...
     * If you're building a theme based on Starter__Theme, use a find and replace
    ...
    register_nav_menus(
        array(
            ...
            'menu-2' => esc_html__('Secondary', 'starter_theme'),
        )
    );
...
/**
 * Register customizer settings and styles for the footer.
 */
function mytheme_customize_register($wp_customize) {
    // Footer Section
    $wp_customize->add_section('footer_settings', array(
        'title' => __('Footer Settings', 'starter_theme'),
        'priority' => 150,
    ));
    ...
    $wp_customize->add_control('footer_text', array(
        'label' => __('Footer Text', 'starter_theme'),
        'section' => 'footer_settings',
        'type' => 'text',
    ));

    // Add Footer Image Setting
    ...
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'footer_image', array(
        'label' => __('Footer Image', 'starter_theme'),
        'section' => 'footer_settings',
    ...
    $social_media_links = array(
        'facebook' => __('Facebook', 'starter_theme'),
        'twitter' => __('Twitter', 'starter_theme'),
...
/**
 * Enqueue custom CSS for the footer.
 */
function mytheme_enqueue_styles() {
    wp_enqueue_style('custom-footer-style', get_template_directory_uri() . '/css/custom-footer.css');
}
